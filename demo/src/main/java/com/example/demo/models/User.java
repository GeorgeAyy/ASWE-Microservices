...
public class User {
    ...
    public User(String user_Lname, String email, String userPassword, String user_fname, String user_address,
    ...
    public boolean equals(Object o) {
        ...
        User user = (User) o;
        return Objects.equals(user_id, user.user_id) && Objects.equals(user_Lname, user.user_Lname)
                && Objects.equals(email, user.email) && Objects.equals(userPassword, user.userPassword)
                && Objects.equals(user_fname, user.user_fname) && Objects.equals(user_address, user.user_address)
